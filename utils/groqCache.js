/**
 * Sistema de Caché para Respuestas de Groq
...
const CACHE_DIR = path.join(__dirname, '..', 'cache', 'groq');
...
class GroqCache {
  ...
  initializeCache() {
    try {
      ...
      if (fs.existsSync(CACHE_FILE)) {
        ...
        console.log(`✅ Caché de Groq cargado: ${this.cache.size} elementos`);
      }
    } catch (error) {
  ...
  generateKey(pregunta, materia) {
    // Usamos String() para forzar la conversión a texto de forma segura
